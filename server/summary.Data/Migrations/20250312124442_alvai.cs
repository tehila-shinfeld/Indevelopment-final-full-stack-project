...
{
    /// <inheritdoc />
    public partial class alvai : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TranscriptionLink = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SummaryLink = table.Column<string>(type: "nvarchar(max)", nullable: false),
